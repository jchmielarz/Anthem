	...
	namespace containers {
		...
		namespace detail {
			...
			template<
				...
				typename NEW_MAP,
				typename... PAIRS>
				struct find_key_and_set_inner_impl;
			...
			template<
				...
				using value = typename find_key_and_set_inner_impl<
					KEY, VALUE,
			...
			struct find_key_and_set_impl {
				using value =
					typename find_key_and_set_inner_impl<KEY, VALUE, map<>, PAIRS...>::value;
			};
			...
			struct set_inner_impl<true, KEY, VALUE, PAIRS...> {
				using value = typename find_key_and_set_impl<KEY, VALUE, PAIRS...>::value;
			};
